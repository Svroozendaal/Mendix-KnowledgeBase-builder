...
layer: L0
l1: importerhelper-act-excelfileimport-importtonp.overview.md
...
---
# Flow Abstract: ImporterHelper.ACT_ExcelFileImport_ImportToNP
- Summary: Likely acts as a save, process, or background step because it mutates data without showing a page.
- L1: [overview](importerhelper-act-excelfileimport-importtonp.overview.md)
