...
layer: L0
l1: importerhelper-act-importtransaction-accepttransactions.overview.md
...
---
# Flow Abstract: ImporterHelper.ACT_ImportTransaction_AcceptTransactions
- Summary: Likely acts as a save, process, or background step for SmartExpenses.Transaction because it mutates data without showing a page.
- L1: [overview](importerhelper-act-importtransaction-accepttransactions.overview.md)
