...
layer: L0
l1: smartexpenses-ds-fbgprofile-retreive-current.overview.md
...
---
# Flow Abstract: SmartExpenses.DS_FBGProfile_Retreive_current
- Summary: Likely acts as a save, process, or background step for Administration.Account, SmartExpenses.FBGProfile because it mutates data without showing a page.
- L1: [overview](smartexpenses-ds-fbgprofile-retreive-current.overview.md)
