...
- Structural score: 90 / 100 (min 80), critical failures: 0, passed: True
- Custom benchmark: skipped
- Final weighted score: 90 / 100
...
|---|---|---|
| S1 | At least one custom flow has a Tier 1 deep narrative. | Tier 1 narrative found in module Sales. |
