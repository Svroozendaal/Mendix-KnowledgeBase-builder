...
- nodeId=n006-decision; caption=IF; expression=trim($Inspector/Telephone) != ''
- nodeId=n007-decision; caption=IF; expression=trim($Inspector/EmailAddress) != ''
- nodeId=n012-decision; caption=IF; expression=trim($Inspector/Location) != ''
- nodeId=n013-decision; caption=IF; expression=trim($Inspector/Country) != ''
