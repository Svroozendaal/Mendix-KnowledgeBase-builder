...
layer: L0
l1: inspection-act-reporthelper-create.overview.md
...
---
# Flow Abstract: Inspection.ACT_ReportHelper_Create
- Summary: Likely acts as a UI entry or navigation handler because it shows Inspection.Report_NewEdit.
- L1: [overview](inspection-act-reporthelper-create.overview.md)
