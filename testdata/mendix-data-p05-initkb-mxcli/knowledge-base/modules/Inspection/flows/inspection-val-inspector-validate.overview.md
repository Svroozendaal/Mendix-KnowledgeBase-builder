...
- nodeId=n006-decision; caption=IF; expression=trim($Inspector/Location) != ''
- nodeId=n007-decision; caption=IF; expression=trim($Inspector/Country) != ''
- nodeId=n014-decision; caption=IF; expression=$Inspector/Level != empty
