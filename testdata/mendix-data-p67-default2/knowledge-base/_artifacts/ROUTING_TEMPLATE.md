...
| Which modules exist? | [app/MODULE_LANDSCAPE.md](app/MODULE_LANDSCAPE.md) |
...
- Use `mxcli-live` allowlisted commands for targeted exact verification when KB files are insufficient.
- Open `app-overview/current/...` only with explicit user approval.
