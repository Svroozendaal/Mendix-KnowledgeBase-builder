...
- nodeId=n010-decision; caption=IF; expression=$Task/Created != empty
- nodeId=n013-decision; caption=IF; expression=$Task/Status != empty
- nodeId=n020-decision; caption=IF; expression=trim($Task/AdditionalRemarks) != ''
- nodeId=n023-decision; caption=IF; expression=$Task/DueDate != empty
