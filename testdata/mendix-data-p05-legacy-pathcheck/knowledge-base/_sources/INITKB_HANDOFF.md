...
- Data root: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-legacy-pathcheck
- Knowledge base root: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-legacy-pathcheck\knowledge-base
...
- Creator link: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-legacy-pathcheck\knowledge-base\_sources\creator-link.json
...
```powershell
.\wizard\run-kb-scaffold.ps1 -Validate -OutputRoot "C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-legacy-pathcheck\knowledge-base" -AppName "Emixa_InspectionApp_P05_Legacy_PathCheck"
.\wizard\run-kb-quality-gate.ps1 -OutputRoot "C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-legacy-pathcheck\knowledge-base" -AppName "Emixa_InspectionApp_P05_Legacy_PathCheck"
```
