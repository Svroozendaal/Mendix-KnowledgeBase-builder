...
- Likely serves as a helper flow invoked from Inspection.SE_Equipment_OrderNew.
...
- Stable JSON: [json](../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-sub-equipment-cast.json)
