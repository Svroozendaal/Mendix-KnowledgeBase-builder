...
l2Path: ../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-registration-validate.json
...
- L2: [json](../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-registration-validate.json)
...
- nodeId=n004-decision; caption=IF; expression=trim($Registration/EmailAddress) != ''
- nodeId=n005-decision; caption=IF; expression=trim($Registration/UserName) != ''
- nodeId=n006-decision; caption=IF; expression=trim($Registration/Password) != ''
- nodeId=n007-decision; caption=IF; expression=$Registration/Role != empty
- nodeId=n012-decision; caption=IF; expression=$Registration/Password = $Registration/ConfirmPassword
...
- Stable JSON: [json](../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-registration-validate.json)
