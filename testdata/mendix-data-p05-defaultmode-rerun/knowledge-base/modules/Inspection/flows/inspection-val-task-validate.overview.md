...
l2Path: ../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-task-validate.json
...
- L2: [json](../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-task-validate.json)
...
- nodeId=n007-decision; caption=IF; expression=$Task/Priority != empty
- nodeId=n008-decision; caption=IF; expression=$Task/Created != empty
- nodeId=n011-decision; caption=IF; expression=$Task/Status != empty
- nodeId=n016-decision; caption=IF; expression=$Task/DueDate != empty
...
- Stable JSON: [json](../../../../../mendix-data-p05-mxcli-rerun/app-overview/current/modules/Inspection/flows/inspection-val-task-validate.json)
