...
- nodeId=n011-decision; caption=IF; expression=trim($Task/Description) != ''
- nodeId=n012-decision; caption=IF; expression=$Task/Priority != empty
- nodeId=n013-decision; caption=IF; expression=$Task/Created != empty
- nodeId=n014-decision; caption=IF; expression=$Task/Status != empty
