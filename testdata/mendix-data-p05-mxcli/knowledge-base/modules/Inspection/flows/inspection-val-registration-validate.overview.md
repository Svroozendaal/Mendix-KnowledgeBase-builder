...
- nodeId=n008-decision; caption=IF; expression=trim($Registration/Password) != ''
- nodeId=n009-decision; caption=IF; expression=$Registration/Role != empty
- nodeId=n016-decision; caption=IF; expression=$Registration/Password = $Registration/ConfirmPassword
