...
layer: L0
l1: inspection-task-newedit.overview.md
...
---
# Page Abstract: Inspection.Task_NewEdit
- Summary: Edit Smart Task. Likely supports create/edit interactions for task because it accepts page parameters.
- L1: [overview](inspection-task-newedit.overview.md)
