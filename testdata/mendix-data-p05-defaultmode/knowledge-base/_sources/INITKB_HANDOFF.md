...
- Data root: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-defaultmode
- Knowledge base root: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-defaultmode\knowledge-base
...
- Creator link: C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-defaultmode\knowledge-base\_sources\creator-link.json
...
```powershell
.\wizard\run-kb-scaffold.ps1 -Validate -OutputRoot "C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-defaultmode\knowledge-base" -AppName "Emixa_InspectionApp_P05_DefaultMode"
.\wizard\run-kb-quality-gate.ps1 -OutputRoot "C:\Workspaces\Mendix-KnowledgeBase-builder-mendix-cli-implementation\mendix-data-p05-defaultmode\knowledge-base" -AppName "Emixa_InspectionApp_P05_DefaultMode"
```
