...
The application supports inspection operations end to end: user registration, inspector profile management, inspection task execution, equipment and tool handling, and report preparation, with notifications triggered for task-related follow-up across roles.

Confidence: Inferred

## Core Business Capabilities

Business capability is concentrated in `Inspection` (operational workflows and data ownership) and `Notification` (task-driven messaging and inbox handling). Together these modules form a lightweight field-operations platform for managers and inspectors.
