...
$unchangedComposerFiles = & git diff --name-only -- "KnowledgeBase-Creator/wizard/run-kb-compose.ps1" "KnowledgeBase-Creator/wizard/run-dump-parser.ps1" "KnowledgeBase-Copilot"
